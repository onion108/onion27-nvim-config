...
local success = pcall(function()
    ...
    keymap.define_keymap("n", "<leader>gw", "<cmd>Telescope grep_string<cr>", "GREP current word using telescope",
        { silent = true })
    ...
    keymap.define_keymap("n", "<leader>gF",
        function() builtin.find_files { hidden = true, no_ignore = true, no_ignore_parent = true } end, "Find file",
        { silent = true })
